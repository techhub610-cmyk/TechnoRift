        ...
        <div className="relative grid lg:grid-cols-2 items-center gap-12 max-w-7xl mx-auto z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-200 font-medium mb-4">
              Boost ROI on the Right Channel with TechnoRift!
            </p>

            {/* Small Paragraph */}
            <p className="text-base text-blue-100 leading-relaxed max-w-xl mb-8">
              Struggling to meet your social media goals? Social media success isn’t rocket science, but when executed with the right strategy, it can deliver exceptional returns. 
              TechnoRift's expert social media management services help you connect with the right audience, elevate your brand’s digital presence, and achieve scalable, profitable growth.
              <br /><br />
              Let us turn your engagement into impact and clicks into conversions.
            </p>
          ...
          >
            <img
              src="/Assets/management.png" // Make sure this path is correct in your public folder
